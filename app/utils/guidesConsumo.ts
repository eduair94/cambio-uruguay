    ...
    faqs: [
      {
        ...
        a: 'En el pago en línea del SUCIVE, la única marca de tarjeta que figuraba en setiembre de 2026 era Visa, además de Banred y otros bancos. Con OCA, lo que corresponde es preguntarle al emisor si te adhiere al débito automático de la patente, porque la Intendencia de Montevideo remite esas consultas a la tarjeta y no interviene en la adhesión.',
      },
      {
  ...
  },
  {
    ...
    faqs: [
      ...
      },
      {
        ...
        a: 'La tasa del Registro por inscribir la compraventa es de $2.530 en trámite normal, según la ficha de gub.uy consultada en setiembre de 2026. A eso se suman los honorarios del escribano, que no tienen tarifa oficial publicada, y el cambio de libreta en la intendencia: $1.779,52 en Montevideo en 2026.',
      },
      {
