...
export const LENDERS: Lender[] = [
  ...
  },
  {
    ...
    source: 'https://www.hsbc.com.uy/prestamos/prestamo-personal/',
    note: 'No publica TEA en página accesible (cartillas en PDF binario); hasta 60 cuotas. Operación en proceso de venta a BTG Pactual (cierre esperado 2.º semestre 2026)',
    rating: null,
    reviewsNote:
      'Percibido como banco premium con servicio personalizado pero red muy pequeña (5 sucursales); incertidumbre por la venta a BTG Pactual',
    reviewSources: [
      {
        label: 'MercoPress — HSBC vende su operación uruguaya',
        url: 'https://es.mercopress.com/2025/07/29/hsbc-vende-sus-operaciones-en-uruguay-a-un-importante-banco-brasileno',
      },
      {
        label: 'Wikipedia — HSBC Bank Uruguay',
        url: 'https://en.wikipedia.org/wiki/HSBC_Bank_Uruguay',
      },
    ],
  },
  // ── Financieras ─────────────────────────────────────────────────────────────
