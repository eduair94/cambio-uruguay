  ...
  },
  {
    ...
    entries: [
      ...
      },
      {
        ...
        labelKey: 'nav.enviarRegalos',
        icon: 'mdi-gift-outline',
        priority: 0.8,
        changefreq: 'monthly',
        fresh: true,
        keywords: [
          'enviar regalo a uruguay',
          'mandar regalo desde el exterior uruguay',
          'regalo desde estados unidos a uruguay',
          'obsequio aduana uruguay',
          'gift card uruguay',
          'enviar dinero a uruguay para regalo',
          'declarar obsequio correo uruguayo',
          'cuanto paga un regalo en la aduana uruguay',
          'franquicia del destinatario uruguay',
        ],
      },
      {
        to: '/couriers-uruguay',
