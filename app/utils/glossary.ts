...
export const glossary: readonly GlossaryTerm[] = [
  ...
  {
    slug: 'despachante-de-aduana',
    term: 'Despachante de aduana',
    category: 'impuestos',
    short:
      'El despachante de aduana es un profesional habilitado que tramita en tu nombre una operación aduanera; el Código Aduanero lo pone como sujeto facultado para esas gestiones y enumera aparte los despachos en los que su intervención no es preceptiva.',
    body: 'El Código Aduanero (Ley 19.276, art. 14) lo define como un sujeto privado, auxiliar del comercio y de la función pública aduanera, que realiza en nombre de otra persona los trámites y diligencias de una operación aduanera. Puede ser persona física o jurídica, y ese mismo art. 14 —cuyo epígrafe es "Definición y preceptividad"— los señala como los sujetos facultados para tramitar las solicitudes de inclusión en regímenes aduaneros, las declaraciones y las demás gestiones de despacho dentro del territorio aduanero. El art. 15 se lee al revés de como suele contarse: se titula "Intervención no preceptiva" y no dice cuándo hace falta un despachante, sino en qué despachos NO lo es. En esa lista están los envíos postales internacionales de carácter no comercial (lit. A), el equipaje del viajero (lit. B) y —el que casi nunca se cita— los envíos postales internacionales de entrega expresa, pero sólo "siempre que su valor en aduana no exceda el equivalente en moneda nacional de US$ 200" (lit. C). Por ese tope no cerramos acá si tu compra puerta a puerta lleva despachante o no: arriba de ese valor la página operativa de la DNA pide despachante para importación general mientras las normas de envíos postales traen exenciones amplias, y ese conflicto lo mostramos sin resolver en la respuesta "¿Necesito despachante para un envío de más de US$ 800?". No lo confundas con el operador postal —el courier o el Correo—: el Decreto 50/026, art. 8, los designa responsables por el pago de obligaciones tributarias de terceros, así que al desconsolidar el envío liquidan y pagan los tributos ante Aduanas antes de entregarte el paquete. Eso es cobrar y verter un tributo, no representarte. Para verificar a uno, ojo: el art. 23 del mismo Código pone a la Dirección Nacional de Aduanas a llevar el Registro de Despachantes de Aduana y de Apoderados, pero la DNA no publica una nómina consultable en línea en su sitio institucional, así que pedile el número de registro y confirmalo ante la DNA. Aparecer en el directorio de una gremial o en un buscador de empresas no es la habilitación.',
    example:
      'Una importación por régimen general con DUA lleva despachante, y ahí es quien firma y responde por la declaración. En un paquete de courier el que declara y paga los tributos ante Aduanas es el propio operador postal; si además hace falta un despachante depende del valor, porque el literal C del art. 15 exceptúa la entrega expresa sólo hasta US$ 200, y ahí la DNA y las normas de envíos postales no dicen lo mismo.',
    related: ['impuestos-importacion', 'franquicia-courier', 'arancel-aduanero'],
  },
