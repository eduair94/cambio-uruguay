...
export const RESIDENCY_KINDS: readonly ResidencyKind[] = Object.freeze([
  {
    ...
    effect:
      'Es lo que te habilita a residir, trabajar en regla y tramitar la cédula. Se pide con documentación personal, antecedentes y acreditación de medios de vida.',
    icon: 'mdi-passport',
  },
  {
    id: 'fiscal',
