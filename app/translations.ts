const translation = {
  en: {
    ...
    here: 'here',
    pay: 'You pay',
    get: 'You get',    searchExchangeHouse: 'Search exchange house (e.g., Itau, Varlix)',
  ...
  pt: {
    ...
    here: 'aqui',
    pay: 'Você paga',
    get: 'Você consegue',    searchExchangeHouse: 'Buscar casa de câmbio (ex: Itau, Varlix)',
  ...
  es: {
    ...
    here: 'aquí',
    pay: 'Pagas en',
    get: 'Obtienes en',    searchExchangeHouse: 'Buscar casa de cambio (ej: Itau, Varlix)',
