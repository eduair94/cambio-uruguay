...
export const ADUANA_FALLBACK: PublicAduanaPayload = {
  ...
  problems: [
    {
      ...
      norm: 'La retención es legal y no requiere causa: los envíos postales internacionales, tengan o no carácter comercial, están sujetos a control aduanero (CAROU art. 141). La DNA confirma que cualquier envío puede ser retenido por control selectivo o aleatorio, y que el destinatario es responsable de justificar todos los datos de su envío. La exigencia documental surge del Decreto 50/026 art. 4 in fine (la DNA debe exigir la información y documentación necesaria) y art. 5 (el envío debe ir acompañado de la documentación que acredite el valor). Desde mayo de 2026 la RG DNA 14/2026 prevé tres vías para los envíos retenidos: despacho presencial, declaración previa por un sujeto habilitado y, para ciertos envíos de operadores postales privados, despacho simplificado gestionado por el propio operador. Esta última vía solo procede si el control no exige modificar la guía, reliquidar ni investigar una posible sanción; el Comunicado 21/2026 confirmó que está operativa desde el 29/05/2026. No es un formulario directo del comprador. Si estás registrado en el registro de identidad de la RG DNA 10/2026 y la información del envío no es consistente con la registrada (por ejemplo, pagaste con una tarjeta no declarada), la mercadería no se libera (num. 6.a.ii). Si no estás registrado, hoy igual se libera, porque el registro es voluntario (num. 1.2 y 7).',
      sourceIds: [
        'carou-141',
        'dna-retenidos',
        'decreto-50-026',
        'rg-dna-10-2026',
        'rg-dna-14-2026',
        'dna-comunicado-21-2026',
        'ley-20446-631',
      ],
      steps: [
        'Identificá el operador y pedile por escrito el motivo operativo de la retención, el número de guía y el depósito asignado. Si llega por Correo Uruguayo, verificá primero que el envío esté declarado en Ahíva.',
        'Si es un courier privado, preguntale si puede tramitar el «despacho simplificado de EPI retenidos» de la RG 14/2026. Lo solicita el operador, no vos, y solo sirve cuando no hay que corregir la guía, reliquidar ni investigar una infracción.',
        'Si el operador confirma que no aplica la vía simplificada, debe indicarte si hará una declaración previa en tu nombre o si corresponde agenda presencial. Para Correo Uruguayo el agendamiento se gestiona por los medios que disponga el propio Correo; para courier, por la Administración de Aduana correspondiente.',
        'Si vas presencialmente, presentate el día y hora asignados. Correo Uruguayo → Centro Operativo, Misiones 1310 esq. Buenos Aires, Ciudad Vieja. Courier → Terminal de Cargas del Uruguay, Camino Carrasco esq. Av. de las Américas, lunes a viernes 9:00-16:00.',
        ...
        'Pagá los tributos que correspondan y retirá. Si hubo declaración previa, el talón vence a los 30 días; si no se paga, se anulan el talón y la declaración y puede iniciarse el abandono. El almacenaje corre por tu cuenta.',
      ],
      deadline:
        'No hay plazo general para que la DNA resuelva. Si una declaración previa genera talón, debe pagarse dentro de 30 días (RG 14/2026, num. 17). Además corre el reloj de abandono: 30 días desde el ingreso al país si hubo incumplimiento y no se pagaron los tributos, o 90 días desde el ingreso si no se retiró la mercadería (Ley 20.446 art. 631).',
      claimBody: 'dna',
      claimTemplate:
    ...
    },
    {
      ...
      norm: 'Hay dos exigencias distintas que la gente mezcla. (a) Lo que se le exige al VENDEDOR extranjero — RG DNA 09/2026: la empresa extranjera debe registrarse ante el Departamento Escribanía de la DNA (Anexo I num. 4), con certificación notarial expedida en Uruguay (Anexo I num. 7 lit. c + Anexo II). Desde el 5/10/2026 ya no tiene que hacerlo sola: la RG 26/2026 permite que el operador postal la dé de alta por LUCIA (resuelto en 48 horas hábiles), habilita a la DNA a incorporarla de oficio y la obliga a publicar la lista de registradas en su web (nums. 1, 2 y 4). Esa misma resolución DEROGA la leyenda sobre residencia fiscal que la factura tenía que traer (num. 7, que deja sin efecto los nums. 5 y 6 del Anexo I de la RG 09/2026). Si el envío trae facturas de varios emisores, basta con que uno no esté registrado para que todo el envío pierda la exoneración (num. 12). El requisito de fondo es exigible desde el 1/10/2026, ya prorrogado dos veces (RG 21/2026 num. 1); la validación automática de LUCIA sobre los identificadores (num. 13) recién corre desde el 3/11/2026 (RG 26/2026 num. 10). El comprador uruguayo NO puede cumplir esta parte: el que se registra es el vendedor. (b) Lo que se le exige al COMPRADOR — Decreto 50/026 art. 4: persona física mayor de edad con documento uruguayo (lit. a); uso personal sin fines comerciales (lit. b); pago con tarjeta de crédito/débito internacional o dinero electrónico de una institución regulada por el BCU (lit. d); el titular del medio de pago debe coincidir con el titular de la compra y el destinatario (lit. e); autorización a las administradoras de tarjetas a informar a la DNA (lit. f, base Ley 20.446 art. 627 inc. 3); mecanismos de control de identidad digital de la DNA (lit. g); y registrarse por única vez ante la DNA (RG DNA 10/2026).',
      sourceIds: [
        'rg-dna-09-2026',
        'decreto-50-026',
        'rg-dna-10-2026',
        'rg-dna-21-2026',
        'dna-vendedores-registrados',
        'ley-20446',
      ],
      steps: [
        ...
        'Antes de comprar (a partir del 1/10/2026), verificá el registro en la página oficial «Régimen de Franquicia» de la DNA. Al 26/07/2026 publica seis empresas: Xipron Inc (Tiendamía), United States Xpress Inc, Grinbox Corp, Netbox Corp, Miami box latinoamérica LLC y Eshop Miami INC. Usá siempre la lista oficial, porque puede cambiar.',
    ...
    },
    {
      ...
      norm: 'No todos los cargos tienen el mismo respaldo. La prestación única (60%, mínimo USD 20/envío) es un tributo (Ley 20.446 art. 627; Decreto 50/026 art. 2). El IVA sobre envíos en franquicia también es un tributo (Decreto 50/026 art. 3), y tiene su propio piso: en el régimen postal el IVA no puede ser inferior al equivalente a USD 20 por envío, salvo que el envío esté integrado exclusivamente por bienes cuya importación esté exonerada (Título 10 del T.O. 2023 art. 13 lit. B, inciso agregado por la Ley 20.446 art. 660; RG DNA 11/2026, Anexo I num. 27). Ese piso no es exclusivo de la prestación única, aunque ni el MEF ni la DNA lo mencionen al explicar la franquicia: por eso un IVA que parece desproporcionado en una compra chica puede estar bien liquidado. El almacenaje/depósito de mercadería retenida va por cuenta del interesado, según la propia DNA, pero el monto es contractual, no está tarifado por norma. El flete, la "gestión", el "handling" y el "despacho" del courier no tienen ninguna norma que los fije: son precio contractual, regido por la Ley 17.250. Esta ley da derecho a información suficiente, clara y veraz en idioma español (art. 6 lit. C, con el mandato operativo del art. 13 inc. 1); la oferta obliga a quien la emite (art. 12); si hay informaciones contradictorias, prevalece la más favorable al consumidor (art. 13 inc. 2); son abusivas las cláusulas que permiten al proveedor modificar unilateralmente el contrato (art. 31 lit. C) o que invierten la carga de la prueba (art. 31 lit. E); y las sanciones van de 20 a 4.000 UR, con decomiso y clausura hasta 90 días (art. 47).',
      sourceIds: [
        'ley-20446',
        'decreto-50-026',
        'dna-retenidos',
    ...
    },
    {
      ...
      norm: 'La franquicia es de hasta 3 (tres) veces por año civil por persona física, independientemente de sus montos y características, y todas las franquicias computan tanto para el tope de USD 800 como para el conteo de envíos (Decreto 50/026 art. 4 lit. c). Los regalos también consumen cupo: el valor de los envíos exonerados por acuerdo comercial u obsequio familiar se imputa al cupo anual (art. 3 inc. 2). Libros y medicamentos de uso personal no consumen ni el tope de USD 800 ni los 3 envíos: el art. 4 inciso final los exceptúa del monto, y la RG DNA 11/2026 num. 26 los exceptúa del numeral 25 lit. b) V, que es el requisito donde viven los dos límites (los medicamentos, sólo con la debida autorización del Ministerio de Salud Pública). Contra-evidencia que conviene tener a mano: la propia DNA comunicó en abril de 2026, sin mencionar la excepción, que todos los envíos en franquicia consumen tanto el cupo en dólares como el de los 3 envíos, y la excepción no aparece en las preguntas frecuentes del MEF ni de la DNA. La fecha que cuenta para el cupo es la del desaduanamiento, no la de compra ni la de arribo. Si te pasás igual y declarás inexactamente el valor o la procedencia para beneficiarte del régimen, la sanción es una multa igual al doble de los tributos que debieron pagarse, y si reiterás dentro de 12 meses, prohibición de operar el régimen por los 12 meses siguientes (Ley 20.446 art. 632). No existe artículo que regule qué pasa cuando el valor de un envío excede el saldo de franquicia disponible: la conclusión de que "la franquicia no se parte" es probable por el diseño del régimen (franquicia "de hasta USD 800", sin mecanismo de aplicación parcial), pero no tiene una norma que la sostenga.',
    ...
    },
    {
      ...
      norm: 'El régimen de EPI no se aplica en ningún caso a mercadería gravada por IMESI, y puede no aplicarse a mercadería restringida — aquella que requiere autorización de algún organismo competente para su importación, exportación o comercialización (Ley 20.446 art. 633). El Decreto 50/026 art. 7 no se aplica a mercadería gravada por IMESI ni a la que requiera autorización de un organismo competente y carezca de ella, pero da la salida: si aún no se produjo el despacho, el interesado puede devolverla a su costo al lugar de procedencia dentro del plazo de 30 días, siempre que no haya incurrido en incumplimiento de la normativa vigente. El corte legal es el DESPACHO, no la verificación: que la DNA haya abierto o revisado el envío no cierra esta puerta. Libros y medicamentos de uso personal quedan exceptuados tanto del tope de USD 800 (art. 4 inc. final) como de los 3 envíos (RG DNA 11/2026 num. 26), los medicamentos sólo con la debida autorización del MSP. Quién autoriza qué, y con qué límite: MSP — el MSP no autoriza el ingreso de productos de salud del exterior por particulares (Decreto 18/020 art. 19); la única puerta es la excepción de producto no registrado, con prescripción médica específica, consentimiento informado y sin equivalente registrado en el país, así que para el resto no hay trámite que puedas iniciar vos. URSEC — equipos radioeléctricos, con certificado previo que la propia persona física tramita en VUCE (celular, router con módem celular, GPS, handy, cámara con conexión celular); pero URSEC NO interviene cuando el dispositivo opera únicamente en 2,4 GHz y/o 5,8 GHz con Wi-Fi 802.11 o Bluetooth 802.15 — auriculares, mouse, smartwatch, joystick, cámaras y similares (Resoluciones URSEC 275/021 y 297/021). MGAP — acá no hay trámite que hacer: la Resolución MGAP 1.720/021 PROHÍBE ingresar por correo o encomienda semillas, plantas, frutas y verduras frescas, animales vivos, alimentos de origen animal, fertilizantes y plaguicidas, sin franja de uso personal, y no encontramos ningún trámite dirigido a persona física para traerlos.',
      sourceIds: ['ley-20446-633', 'decreto-50-026', 'dna-prohibidos'],
      steps: [
        'Primero fijate si ese permiso existe para vos: la Resolución MGAP 1.720/021 PROHÍBE ingresar por correo o encomienda semillas, plantas, frutas y verduras frescas, animales vivos, alimentos de origen animal, fertilizantes y plaguicidas, y no hay trámite de persona física para traerlos; el MSP tampoco autoriza el ingreso de productos de salud por particulares, salvo la excepción de producto no registrado. Si tu envío cae ahí, saltá directo al paso de la devolución a origen. Si el permiso sí existe (URSEC para equipos radioeléctricos, y no para los que funcionan sólo con Wi-Fi o Bluetooth en 2,4/5,8 GHz), conseguí el certificado del organismo ANTES de pedir agenda en Aduana: para retirar envíos con mercadería de ingreso restringido y retenidos, hace falta el certificado de autorización del organismo correspondiente antes de cualquier trámite en Aduana.',
  ...
  sources: [
    ...
    {
      id: 'rg-dna-14-2026',
      title: 'Procedimiento de control aduanero de envíos postales retenidos',
      norm: 'RG DNA 14/2026 (05/05/2026)',
      url: 'https://www.aduanas.gub.uy/innovaportal/file/28482/1/rg-14-2026.pdf',
      checkedAt: '2026-07-26',
      kind: 'norma',
    },
    {
      id: 'dna-comunicado-21-2026',
      title: 'Habilitación del despacho simplificado de EPI retenidos para operadores privados',
      norm: 'Comunicado AGCE 21/2026 (29/05/2026)',
    ...
    {
      id: 'dna-vendedores-registrados',
      title: 'DNA — régimen de franquicia y empresas extranjeras registradas',
      norm: 'portal oficial del régimen vigente desde el 01/05/2026',
      url: 'https://www.aduanas.gub.uy/innovaportal/v/28221/1/innova.front/',
      checkedAt: '2026-07-26',
      kind: 'pagina-oficial',
    },
    {
      id: 'mef-informe-datos-franquicia',
      title: 'MEF/DNA — respuesta oficial sobre datos personales del registro de franquicias',
      norm: 'pedido de informes, expediente 2026-5-1-0006449 (16/07/2026)',
