...
const description =
  'Prex y Mercado Pago pagan rendimiento diario por el saldo, y no es interés: la Ley 19.210 lo prohíbe, es un fondo. Qué rinde y qué queda tras la inflación.'
