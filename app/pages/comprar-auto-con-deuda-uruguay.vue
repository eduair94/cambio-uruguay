...
const description =
  'La deuda no pasa a ser tuya, pero bloquea la transferencia: comprás un auto que no podés poner a tu nombre. Calculadora del costo real con mora y recargo.'
