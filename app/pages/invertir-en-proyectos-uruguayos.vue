<template>
  <VContainer class="proyectos-page pb-8">
    ...
    <VCard class="overflow-hidden mb-4" elevation="8">
      <div class="bg-gradient-proyectos pa-6 on-dark">
...
const description =
  'Crowdfunding (Crowder), obligaciones negociables, fideicomisos de forestación e infraestructura, agro y startups: regulación BCU, riesgo e impuestos.'
