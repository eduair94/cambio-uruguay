...
const title = 'Renuncié en Uruguay: qué cobro y en 10 días'
const description =
  'Quien renuncia cobra licencia no gozada, salario vacacional y aguinaldo: exigible a los 10 días corridos, con recargo del 10 % si no pagan (Ley 18.572).'
