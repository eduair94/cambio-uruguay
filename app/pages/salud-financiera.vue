<template>
  <VContainer class="salud-page pb-8">
    <!-- Breadcrumb -->
    <div class="mb-3">
...
const description =
  'Test de salud financiera personal e ideas de ingresos extra en Uruguay, con datos verificados de monotributo, IRPF, BPS e inflación. Ordená tu plata.'
