<template>
  <VContainer class="apps-page pb-8">
    <!-- Breadcrumb -->
    <div class="mb-3">
...
const description =
  'Directorio de apps para tu plata en Uruguay: BROU, Itaú, Santander, BBVA, Mercado Pago, Prex y MiDinero, más inversión, cripto y los trámites de BPS y DGI.'
