...
- Preparar un piloto de adquisición sobre históricos existentes a partir de `organic-entrypoints-decision.md`. Verificar intención de búsqueda y estado de cada destino antes de intervenir; el agregado de una familia no convierte todas sus páginas en oportunidades equivalentes.
