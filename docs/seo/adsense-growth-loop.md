...
Validación local: 7.378 pruebas del frontend aprobadas (44 omitidas), incluidas siete nuevas de ciclo de vida de anuncios; lint dirigido sin errores y revisión independiente de ambas partes. El backend aprobó 2.656 pruebas, pero su barrido de archivos encontró clones temporales preexistentes `.sdd-*` y una prueba agotó el tiempo al ejecutar las dos suites a la vez. La prueba de descarga y las de privacidad de ingresos pasaron al repetirlas con dos workers (37/37). La suite de CI en un checkout limpio es el control final antes del despliegue. No se borraron esos archivos ajenos ni se modificaron las guardas para ocultarlos.

Estado de despliegue: pendiente de CI. Ningún aumento de ingresos se atribuye al parche antes de medirlo.
