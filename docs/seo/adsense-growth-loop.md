...
- Preparar la ampliación puntual de la guía de IRPF existente a partir de la investigación oficial ya guardada en `data/revenue-2026-09-14/next-demand-candidate.md`. Distinguir consulta, declaraciones pendientes y reliquidación; conservar los límites de las fuentes sobre créditos antiguos. La cola propone una hipótesis editorial, no demuestra volumen ni autoriza publicar afirmaciones sin respaldo.
