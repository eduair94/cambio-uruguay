...
11. **El IRAE ficto que mostramos está SOBREESTIMADO, a propósito.** El art. 64 permite deducir de la renta ficta *"los sueldos de dueños o socios admitidos por la reglamentación"*. **No lo descontamos**, porque no preguntamos si el dueño se paga sueldo. El IRAE que mostramos es por lo tanto un **techo**, no una predicción.
    - **CORRECCIÓN (revisión 2, 2026-07-13):** este ítem —y la nota que la página mostraba al usuario— afirmaban que el tope de la deducción era de **"hasta 11 BFC por dueño o socio que preste servicios efectivos"**. **Es falso, y lo verificamos contra el texto.** El inciso empresarial del art. 64 no tiene tope ni número: dice solo *"deduciendo los sueldos de dueños o socios admitidos por la reglamentación"*. Las **11 BFC** existen en el art. 64, pero en **otro inciso** — el **agropecuario**: *"b) Por cada dueño o socio, once Bases Fictas de Contribución mensuales en concepto de retribución patronal, a condición de que se presten efectivos servicios..."*. Ese régimen **no gobierna el ficto empresarial** que aplica esta página. La cifra (y el *"servicios efectivos"*) estaban tomadas prestadas de un régimen ajeno. Se removió el número de la nota; **no se sustituyó por otro, porque no hay otro que citar.**
    - **Lección de mecanismo:** el guard AST del módulo recorre `NumericLiteral`s y **no puede ver un número que vive dentro de un string**. Toda cantidad afirmada en prosa está fuera de su alcance y solo puede sostenerla una persona leyendo la norma.
...
14. ~~**Gradualidad Ley 19.889 para un titular que YA tiene FONASA por un empleo:** BPS no publica una versión rebajada de esa columna.~~ **RESUELTO — ERA FALSO (revisión 2, 2026-07-13).** BPS **sí la publica**. La página de aportación gradual (bps.gub.uy/17829) trae la columna *"Con aporte al SNS por actividad dependiente (SS 2, 28, 29 y 30)"* en **las cuatro tablas anuales**, 1.ª categoría / 11 BFC: **3.999 · 4.380 · 4.761 · 5.143**. El modelo estaba **cobrando de más** ($1.144/mes a un Literal E nuevo) *y* diciéndole al usuario que BPS no había publicado un número que estaba en la página de BPS. Ahora se aplica la rampa. **Una "conservadurismo" inventado sigue siendo un invento.**
15. **La frontera del UI 4.000.000.** La norma mide los ingresos del **ejercicio anterior**; nosotros solo tenemos la facturación anual estimada del visitante para el ejercicio **actual**. Esa aproximación queda, y la ficha lo dice.
    - **CORRECCIÓN (revisión 2):** además convertíamos el tope con la **UI de hoy**, que se mueve todos los días. El art. 168 lit. b) **fija la fecha**: los ingresos se miden *"a valores de **cierre de ejercicio**"*, y el lit. c) lo repite (*"se tomará la cotización de la unidad indexada vigente **al cierre de ejercicio**"*). Ahora el tope usa `uiCierre2025` (**6,4237**), que ya existía en el módulo etiquetada *"fija los topes 2026"* y **no estaba referenciada en ningún lado**. Los **tramos del art. 64** siguen convirtiéndose con la UI de hoy: a diferencia del art. 168, **el art. 64 no dice a qué fecha valuarlos**, así que esa conversión es una aproximación nuestra y se declara como tal.
16. **¿Un profesional amparado por la CJPPU que factura A TRAVÉS DE UNA EMPRESA UNIPERSONAL, aporta a BPS, a la Caja, o a las dos?** **NO LO PODEMOS AFIRMAR, y es la incógnita más cara de la página.** Lo que sí sabemos:
    - Ley 17.738 **art. 43**: quedan amparados los profesionales que ejerzan *"en forma libre **en nombre propio** y para terceros"*. Una **empresa unipersonal no es una persona jurídica distinta del titular**, así que facturar por ella **sigue siendo "en nombre propio"** — cae dentro del supuesto.
    - Pero el **mismo art. 43** cierra diciendo que el ejercicio (incluso **"en sociedad"**) rige *"**sin perjuicio de las afiliaciones a otros institutos de seguridad social que pudieran corresponder**"* — es decir, **contempla expresamente que BPS pueda deberse ADEMÁS**, sin decir cuándo.
    - Y para la **SAS**, la Ley 19.820 **art. 43** manda positivamente al administrador al *"régimen general previsto en el **artículo 172 de la Ley 16.713**"* (o sea, **a BPS**), sin decir qué pasa cuando ese administrador está amparado por la CJPPU.
    - **Ninguna de las dos normas resuelve el choque, y la CJPPU no publica su escala.** Un investigador anterior tampoco pudo establecerlo desde fuentes primarias.
    - **Decisión:** en **todos** los regímenes (no solo en IRPF Cat. II), un `cajaProfesional` que preste servicios recibe `bpsUnknown: true` y **total nulo**, con nota que lo manda a la Caja. **No adivinamos en ninguna de las dos direcciones.** El bug que esto corrige: antes IRPF Cat. II se negaba a dar un total y el régimen de al lado le entregaba a la misma persona **un total completo y más barato**, cuyo componente BPS es un jubilatorio que quizá no le pague a BPS.
17. **¿Cuántos administradores tiene una SAS?** **No hay máximo legal.** (Se creía que eran "hasta 3"; **la Ley 19.820 no dice eso en ningún lado**.) El art. 30 dice que la representación legal está *"a cargo de **una o más** personas físicas o jurídicas, designadas en la forma prevista en los estatutos"*. Lo que sí hay es un **default de la propia norma**: el **art. 29** dispone que *"Salvo que otra cosa se dispusiera en los estatutos, la **totalidad** de las funciones de administración y representación legal le corresponderán **al representante legal**"* (singular). Por eso el modelo **puede** asumir **1** administrador cuando no se lo dicen — es la regla residual de la ley, no una suposición nuestra — pero acepta `administradoresSas` y multiplica si el usuario nombra más. **La SRL no tiene nada equivalente:** la Ley 16.060 art. 1 la obliga a **≥2 socios**, así que "1" nunca es su forma por defecto, y por eso allí la falta del dato es un **desconocido** y no un default.
