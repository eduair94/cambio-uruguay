...
5. **Preferencias de barrio.** El hogar puede preferir barrios, limitar la búsqueda a ellos o excluirlos, siempre indicando su departamento. En modo preferir, con una lista de inclusiones no vacía, el puntaje anterior aporta el 90 % y una coincidencia aporta diez puntos adicionales; las demás opciones aportan cero por zona. Esta preferencia no adelanta datos incompletos ni un déficit conocido respecto de opciones completas financieramente factibles. Sin preferencias activas se conserva el cálculo anterior. Las zonas se comprueban contra el mismo aviso que aporta el precio, manteniendo ofertas alternativas válidas. Detalles, tratamiento de datos desconocidos y estadísticas en [PROPERTY_ZONE_MARKET.md](PROPERTY_ZONE_MARKET.md).
