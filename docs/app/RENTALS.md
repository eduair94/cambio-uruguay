...
La garantía de arrendamiento identificada expresamente en la descripción o en el campo propio del aviso también demuestra el contexto de alquiler en UYU, aunque el título no use esa palabra. Esto recupera cinco avisos económicos adicionales frente a la primera selección (53→58 hasta $13.000). No se toma publicidad de la inmobiliaria ni garantías de construcción, ni se deduce un período mensual para USD por esa señal. Los traspasos sin un importe de alquiler mensual explícito se excluyen de la selección económica: la cifra podría corresponder a una cesión o derecho de llave.
...
La lectura real de comprobación del 7 de septiembre, 00:07–00:37 UTC, terminó las cinco franjas: **872 páginas y 17.663 IDs únicos**, de los cuales **14.272** pasan el parser y la plausibilidad (11.361 casas/apartamentos). Entre las viviendas publicadas en UYU hay 78 hasta $13.000; 58 cumplen también los criterios económicos estrictos. Los cuatro avisos de $6.500–$7.000 mencionados arriba están presentes y admitidos. Son cifras de la captura, no altas nuevas ni cobertura completa del portal.

La captura se incorporó a producción a las **01:16 UTC del 7 de septiembre**, bajo el mismo `flock` que los jobs y con respaldo previo de catálogo y metadatos. Agregó **5.534 anuncios**, incluidos **3.977 de casas/apartamentos**: 31.724 → 37.258 anuncios almacenados. Se conservaron intactos los 22.986 anuncios no observados, sin caducar por ausencia ni renovar sus fechas, y la comprobación final encontró cero pertenencias duplicadas. Una única URL cambió porque el título canónico antiguo no correspondía al anuncio y publicaba una dirección que la fuente oculta; no se heredó esa identidad incorrecta. Las cifras almacenadas incluyen históricos: no equivalen al total visible.

El aumento expuso un límite de la consulta general: ordenar documentos con galerías y descripciones antes de proyectarlos superaba los 100 MiB de Mongo (`code: 292`). Lista y mapa ahora descartan la evidencia rica antes de ordenar; la mediana proyecta únicamente `priceUyu`. La selección del aviso se mantiene antes de la proyección, y el mapa conserva internamente `priceUyu` y `freshAt` para sus órdenes. Una reproducción en Mongo aislado hace fallar las consultas anteriores y comprueba que la corrección conserva mediana par/impar, páginas profundas, selección de fuente y los cuatro órdenes sin habilitar uso de disco.
