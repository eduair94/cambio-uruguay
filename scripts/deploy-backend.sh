...
OTHER_APPS=(currency-sync currency-aduana currency-aduana-daily currency-sheet currency-banks-news currency-figures currency-costs currency-financing currency-debt-relief currency-bcu-rates currency-loans currency-loan-tiers currency-predictions currency-explain currency-bankos currency-chair-tiers currency-chairs currency-chairs-hourly currency-equipar currency-equipar-hourly currency-movilidad currency-movilidad-hourly currency-phones currency-phones-hourly currency-rentals currency-rentals-hourly currency-property-opportunities currency-property-opportunities-hourly currency-autos currency-autos-hourly currency-autos-guide currency-autos-parts currency-autos-detail currency-rentals-detail currency-property-services currency-property-zones currency-property-zones-hourly currency-power-outages currency-water-interruptions currency-site-analytics currency-gsc currency-search-demand currency-revenue-plan currency-store-profiles currency-store-reddit currency-temas-analysis currency-rag-index currency-reddit-bot currency-reddit-bot-watch currency-reddit-stats currency-content-gaps currency-trends currency-videos currency-regional currency-regional-history currency-precios currency-combustibles currency-charruadevs currency-price-events currency-price-events-hourly currency-market-series currency-price-changes currency-transporte currency-motos currency-motos-hourly)
