...
OTHER_APPS=(currency-sync currency-aduana currency-aduana-daily currency-sheet currency-banks-news currency-figures currency-costs currency-financing currency-debt-relief currency-bcu-rates currency-loans currency-loan-tiers currency-predictions currency-explain currency-bankos currency-chair-tiers currency-chairs currency-chairs-hourly currency-rentals currency-rentals-hourly currency-property-opportunities currency-property-opportunities-hourly currency-site-analytics currency-gsc currency-search-demand currency-temas-analysis currency-rag-index currency-reddit-bot currency-reddit-bot-watch currency-reddit-stats currency-content-gaps currency-trends currency-videos currency-regional currency-regional-history)
