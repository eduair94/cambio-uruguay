...
OTHER_APPS=(currency-sync currency-aduana currency-aduana-daily currency-sheet currency-banks-news currency-figures currency-costs currency-financing currency-debt-relief currency-loans currency-predictions currency-explain currency-chair-tiers currency-chairs currency-chairs-hourly currency-site-analytics currency-temas-analysis currency-rag-index currency-reddit-bot currency-reddit-bot-watch currency-reddit-social currency-reddit-ask currency-content-gaps)
