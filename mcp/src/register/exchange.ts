// The original exchange-rate toolset (cambio): 7 tools + the dolar prompt, unchanged
// since they moved here from server.ts.
...
export const EXCHANGE_TOOLS = ["get_rates", "best_house", "convert", "list_houses", "get_evolution", "get_news", "daily_summary"] as const;

export function registerExchange(server: McpServer, api: CambioApi): void {
  server.registerTool(
    "get_rates",
    {
