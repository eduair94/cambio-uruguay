...
//
// The original snapshot was transcribed from
// docs/superpowers/research/2026-07-12-aduana-problemas-research.md (§1 sources, §2 facts, §4 the
// 12 buckets). Sources and procedures revalidated after that date are recorded in
// docs/superpowers/research/2026-07-26-aduana-reddit-faq-audit.md. Do not add a fact that is not
// supported by one of those human-reviewed records.
//
