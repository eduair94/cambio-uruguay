...
class CambioObelisco extends Cambio {
  bcu =
    "https://www.bcu.gub.uy/Servicios-Financieros-SSF/Paginas/InformacionInstitucion.aspx?nroinst=2458";
  private conversions = {
    Dolar: {
      code: "USD",
      type: "",
  ...
  async get_data(): Promise<CambioObj[]> {
    ...
    const $ = load(web_data);
    const result = $(
      "#left_col > table:nth-child(2) > tbody > tr:nth-child(2) > td > table > tbody > tr > td > table tbody tr",
    )
