// Shared HTTP plumbing for the retail harvesters (chairs, household goods, anything later).
//
...
const HOST_GAP_MS = Number(process.env.RETAIL_HOST_GAP_MS || process.env.CHAIR_HOST_GAP_MS || 350);
const DEFAULT_TIMEOUT_MS = Number(process.env.RETAIL_HTTP_TIMEOUT_MS || process.env.CHAIR_HTTP_TIMEOUT_MS || 20_000);
